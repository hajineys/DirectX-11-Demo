...
public:
	...
	void SetPoiLight(const PointLight* light)			{ PoiLight->SetRawValue(light, 0, sizeof(PointLight)); }
	void SetSptLight(const SpotLight* light)			{ SptLight->SetRawValue(light, 0, sizeof(SpotLight)); }
	...
	ID3DX11EffectVariable* PoiLight;
...
class BasicDifMapEffect : public Effect
{
public:
	BasicDifMapEffect(ID3D11Device* device, const std::wstring& filename);
	~BasicDifMapEffect();
...
#pragma region BasicTexAlphaEffect
class BasicTexAlphaEffect : public Effect
{
public:
	BasicTexAlphaEffect(ID3D11Device* device, const std::wstring& filename);
	~BasicTexAlphaEffect();
...
public:
	...
	static BasicDifMapEffect* BasicDifMapFX;
	static BasicTexAlphaEffect* BasicTexAlphaFX;
};
#pragma endregion
